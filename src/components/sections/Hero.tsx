...
export default function Home() {
  ...
  return (
    <main>
      <section className="relative min-h-[75vh] w-full" style={{ backgroundColor: '#01B2D6' }}>
        ...
        <div className={`relative z-10 flex flex-col h-full pointer-events-none px-4 md:px-16 lg:px-24 ${isMobile ? 'pt-24' : 'pt-32'}`}>
          ...
          <div className="mt-auto pt-16 md:pt-24 pb-8 md:pb-12 -mx-4 md:-mx-16 lg:-mx-24 px-4 md:px-16 lg:px-24" style={{ position: 'relative', zIndex: 10 }}>
