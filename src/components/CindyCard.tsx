...
const scenarios = [
  {
    ...
    audioFile: '/audio/cindy-insurance.mp3',
    duration: 30
  },
  {
    id: 'appointment',
    ...
    audioFile: '/audio/cindy-appointment.mp3',
    duration: 36
  },
  {
    id: 'billing',
    ...
    audioFile: '/audio/cindy-billing.mp3',
    duration: 28
  }
];
...
export default function CindyCard() {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: '#111827', fontWeight: 600, fontSize: isMobile ? '0.875rem' : '1.125rem', fontStyle: 'italic' }}>Have you met Cindy?</span>
      </div>
                ...
                {isPlaying && (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        <p style={{ fontSize: '0.875rem', color: '#4b5563', marginBottom: '0.5rem', fontWeight: 500 }}>Cindy responds:</p>
                        <motion.p
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
